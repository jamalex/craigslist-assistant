...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Apartment.small_notes'
        db.alter_column(u'apartments_apartment', 'small_notes', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Apartment.small_notes'
        db.alter_column(u'apartments_apartment', 'small_notes', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
